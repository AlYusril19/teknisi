...
>
  <head>
    ...
    <title>Dashboard | Laporan Kerja Teknisi</title>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('teknisi.index') }}" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ \Route::is('laporan.*') ? 'active open' : '' }}">
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ \Route::is('laporan-all.index') ? 'active' : '' }}">
                  <a href="{{ route('laporan-all.index') }}" class="menu-link">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              @if($errors->any())
              <div class="alert alert-danger fade-show" role="alert" id="alert-messages">
